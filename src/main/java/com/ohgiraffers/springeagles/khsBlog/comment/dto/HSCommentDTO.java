package com.ohgiraffers.springeagles.khsBlog.comment.dto;
...
public class HSCommentDTO {
    ...
    // 매개변수를 받는 생성자
    public HSCommentDTO(Long commentID, String commentContent, LocalDateTime commentDate,
    ...
    public static HSCommentDTO fromEntity(HSCommentEntity entity) {
        return new HSCommentDTO(
                entity.getCommentID(),
    ...
    public HSCommentEntity toEntity() {
        HSCommentEntity entity = new HSCommentEntity();
