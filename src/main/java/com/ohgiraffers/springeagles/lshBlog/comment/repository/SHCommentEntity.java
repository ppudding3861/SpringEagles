...
public class SHCommentEntity {
    ...
    private SHPostsEntity SHPostsEntity;

    // 기본 생성자
    public SHCommentEntity() {}

    // 매개변수를 받는 생성자
    public SHCommentEntity(Long commentID, String commentContent, LocalDateTime createdDate, LocalDateTime modifiedDate, String commentAuthor) {
    ...
    public void setPostsEntity(SHPostsEntity SHPostsEntity) {
        this.SHPostsEntity = SHPostsEntity;
    }
