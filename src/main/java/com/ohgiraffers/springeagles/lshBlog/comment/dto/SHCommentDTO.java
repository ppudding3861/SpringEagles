...
public class SHCommentDTO {
    ...
    // 매개변수를 받는 생성자
    public SHCommentDTO(Long commentID, String commentContent, LocalDateTime commentDate,
    ...
    public static SHCommentDTO fromEntity(SHCommentEntity entity) {
        return new SHCommentDTO(
                entity.getCommentID(),
    ...
    public SHCommentEntity toEntity() {
        SHCommentEntity entity = new SHCommentEntity();
