...
public class SHPostsEntity {
    ...
    private List<SHCommentEntity> comments = new ArrayList<>();
    ...
    public SHPostsEntity(Long id, String title, String description, String imageUrl, String content,
                         LocalDateTime createdAt, String tagArrayAsString, int likesCount,
                         List<SHCommentEntity> comments) {
        this.id = id;
        this.title = title;
    ...
    public SHPostsEntity(SHPostsDTO dto) {
        this.id = dto.getId();
