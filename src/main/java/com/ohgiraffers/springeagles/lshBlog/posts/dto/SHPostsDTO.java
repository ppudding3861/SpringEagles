package com.ohgiraffers.springeagles.lshBlog.posts.dto;
...
public class SHPostsDTO {
    ...
    public SHPostsDTO(Long id, String title, String description, String imageUrl, String content,
                      LocalDateTime createdAt, String tagArrayAsString, int likesCount, List<SHCommentDTO> comments) {
        this.id = id;
        this.title = title;
    ...
    public SHPostsDTO(SHPostsEntity entity) {
