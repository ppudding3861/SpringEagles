...
public class JHPostsDTO {
    ...
    private List<JHCommentDTO> comments;
    private int commentsCount;

    public JHPostsDTO() {}

    public JHPostsDTO(Long id, String title, String description, String imageUrl, String content,
                      LocalDateTime createdAt, String tagArrayAsString, int likesCount, List<JHCommentDTO> comments) {
        this.id = id;
        this.title = title;
    ...
    public List<JHCommentDTO> getComments() {
        return comments;
    }

    public void setComments(List<JHCommentDTO> comments) {
        this.comments = comments;
    ...
    // DTO를 Entity로 변환
    public JHPostsEntity toEntity() {
        return new JHPostsEntity(this);
    }
