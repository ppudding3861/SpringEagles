...
public class JHPostsEntity {
    ...
    private List<JHCommentEntity> comments = new ArrayList<>();
    ...
    public JHPostsEntity() {
    }

    public JHPostsEntity(Long id, String title, String description, String imageUrl, String content,
                         LocalDateTime createdAt, String tagArrayAsString, int likesCount,
                         List<JHCommentEntity> comments) {
        this.id = id;
        this.title = title;
    ...
    public List<JHCommentEntity> getComments() {
        return comments;
    }

    public void setComments(List<JHCommentEntity> comments) {
        this.comments = comments;
    }
