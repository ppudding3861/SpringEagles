...
public class EJPostsEntity {
    ...
    private List<EJCommentEntity> comments = new ArrayList<>();
    ...
    public EJPostsEntity(Long id, String title, String description, String imageUrl, String content,
                         LocalDateTime createdAt, String tagArrayAsString, int likesCount,
                         List<EJCommentEntity> comments) {
        this.id = id;
        this.title = title;
    ...
    public EJPostsEntity(EJPostsDTO dto) {
        this.id = dto.getId();
