package com.ohgiraffers.springeagles.sejBlog.posts.dto;
...
public class EJPostsDTO {
    ...
    public EJPostsDTO(Long id, String title, String description, String imageUrl, String content,
                      LocalDateTime createdAt, String tagArrayAsString, int likesCount, List<EJCommentDTO> comments) {
        this.id = id;
        this.title = title;
    ...
    public List<EJCommentDTO> getComments() {
        return comments;
    }

    public void setComments(List<EJCommentDTO> comments) {
        this.comments = comments;
    ...
    public EJPostsDTO(EJPostsEntity entity) {
    ...
    // DTO를 Entity로 변환
    public EJPostsEntity toEntity() {
        return new EJPostsEntity(this);
    }
