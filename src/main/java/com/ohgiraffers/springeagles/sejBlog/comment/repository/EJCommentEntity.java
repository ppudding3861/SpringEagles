...
public class EJCommentEntity {
    ...
    private EJPostsEntity EJPostsEntity;

    // 기본 생성자
    public EJCommentEntity() {}

    // 매개변수를 받는 생성자
    public EJCommentEntity(Long commentID, String commentContent, LocalDateTime createdDate, LocalDateTime modifiedDate, String commentAuthor) {
    ...
    public void setPostsEntity(EJPostsEntity EJPostsEntity) {
        this.EJPostsEntity = EJPostsEntity;
    }
