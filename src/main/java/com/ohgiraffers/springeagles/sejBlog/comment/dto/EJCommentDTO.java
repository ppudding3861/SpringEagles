package com.ohgiraffers.springeagles.sejBlog.comment.dto;
...
public class EJCommentDTO {
    ...
    // 매개변수를 받는 생성자
    public EJCommentDTO(Long commentID, String commentContent, LocalDateTime commentDate,
    ...
    public static EJCommentDTO fromEntity(EJCommentEntity entity) {
        return new EJCommentDTO(
                entity.getCommentID(),
    ...
    public EJCommentEntity toEntity() {
        EJCommentEntity entity = new EJCommentEntity();
