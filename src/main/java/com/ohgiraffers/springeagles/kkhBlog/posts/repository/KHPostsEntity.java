...
public class KHPostsEntity {
    ...
    private List<KHCommentEntity> comments = new ArrayList<>();
    ...
    public KHPostsEntity() {
    }

    public KHPostsEntity(Long id, String title, String description, String imageUrl, String content,
                         LocalDateTime createdAt, String tagArrayAsString, int likesCount,
                         List<KHCommentEntity> comments) {
        this.id = id;
        this.title = title;
    ...
    public KHPostsEntity(KHPostsDTO dto) {
        this.id = dto.getId();
    ...
    public List<KHCommentEntity> getComments() {
        return comments;
    }

    public void setComments(List<KHCommentEntity> comments) {
        this.comments = comments;
    }
