package com.ohgiraffers.springeagles.kkhBlog.posts.dto;
...
public class KHPostsDTO {
    ...
    private List<KHCommentDTO> comments;
    private int commentsCount;

    public KHPostsDTO() {}

    public KHPostsDTO(Long id, String title, String description, String imageUrl, String content,
                      LocalDateTime createdAt, String tagArrayAsString, int likesCount, List<KHCommentDTO> comments) {
        this.id = id;
        this.title = title;
    ...
    public List<KHCommentDTO> getComments() {
        return comments;
    }

    public void setComments(List<KHCommentDTO> comments) {
        this.comments = comments;
    ...
    public KHPostsDTO(KHPostsEntity entity) {
    ...
    // DTO를 Entity로 변환
    public KHPostsEntity toEntity() {
        return new KHPostsEntity(this);
    }
