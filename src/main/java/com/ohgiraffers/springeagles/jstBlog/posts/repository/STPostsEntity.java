...
public class STPostsEntity {
    ...
    private List<STCommentEntity> comments = new ArrayList<>();
    ...
    public STPostsEntity() {
    }

    public STPostsEntity(Long id, String title, String description, String imageUrl, String content,
                         LocalDateTime createdAt, String tagArrayAsString, int likesCount,
                         List<STCommentEntity> comments) {
        this.id = id;
        this.title = title;
    ...
    public List<STCommentEntity> getComments() {
        return comments;
    }

    public void setComments(List<STCommentEntity> comments) {
        this.comments = comments;
    }
