...
public class STCommentDTO {
    ...
    // 매개변수를 받는 생성자
    public STCommentDTO(Long commentID, String commentContent, LocalDateTime commentDate,
    ...
    public static STCommentDTO fromEntity(STCommentEntity entity) {
        return new STCommentDTO(
                entity.getCommentID(),
    ...
    public STCommentEntity toEntity() {
        STCommentEntity entity = new STCommentEntity();
